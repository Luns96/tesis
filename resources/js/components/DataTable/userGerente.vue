    ...
    >
      <template v-slot:items="props">
        ...
        <td  class="text-xs-left">
          ...
          <v-btn
            v-if="props.item.id === connectUser.id"
            color="blue" 
            icon
          ...
          <template v-else-if="props.item.roles[0].id === 2">
          <v-btn
            color="blue" 
            icon
            @click="editUser(props.item)"
...
<script>
  export default {
    ...
    methods:{
        getUser(){
            var urlTypes= "userGerente/index";
        ...
        createUser() {
            ...
            this.addItemUser.company = this.connectUser.company_id;
            this.addItemUser.rol = 'Gerente';
            this.addItemUser.ci = this.newCI;
            this.addItemUser.surname = this.newSurname;
            var url = 'api/user';
            console.log(this.addItemUser)
